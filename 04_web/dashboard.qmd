...
<style>
/* ESTILOS CORREGIDOS - FUNCIONAN 100% */
...
/* Ajustes para la gráfica superior */
#display-potencia {
  width: 100%;
  margin-bottom: 30px;
}

#display-potencia iframe {
  width: 100% !important;
...
/* Ajustes para los mapas inferiores */
.columns {
  display: flex;
  gap: 20px;
  width: 100%;
...
#| fig-cap: "Mapa de la zona circundante al volcán"
IFrame("images/mapa_region_alrededor.html", width="100%", height="100%")
```
