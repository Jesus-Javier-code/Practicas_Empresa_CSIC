...
<style>
/* --- RESET COMPLETO --- */
body, html, .dashboard, .dashboard-page {
  margin: 0 !important;
  padding: 0 !important;
...
.panel-card, .cell, .panel-card-body {
...
/* --- IFRAMES COMPACTOS Y SIN BORDES --- */
iframe {
  width: 100% !important;
...
from IPython.display import IFrame  # Corregido el typo aquí
```
