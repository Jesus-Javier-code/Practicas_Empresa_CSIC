...
# Ruta de la carpeta "images" dentro del directorio Practicas_Empresa_CSIC/04_web
output_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'Practicas_Empresa_CSIC', '04_web', 'images')
