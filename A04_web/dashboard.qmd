...
<div class="main-container">
  <!-- Hero Banner -->
  <div class="hero-banner">
    <div class="hero-title">Earthquakes</div>
    <div class="hero-subtitle">
  ...
  <div class="top-container">
    <!-- Mapa (ahora a la izquierda visualmente) -->
     <div class="video-wrapper">
      <div class="video-container">
        <iframe src="https://www.youtube.com/watch?v=Dm0WbAxhRP8" allowfullscreen></iframe>
      </div>
      <div class="video-caption">Explanation of earthquake formation</div>
    </div>
    </div>
    ...
    <div class="text-containert">
      <div class="context-box">
        ...
        <div class="context-text">
          <p>When starting periods of volcanic activity it is usual to register a larger number of seismic events due to the vibrations caused by the flow of the magma, gases and other fluids that could be present in the magmatic chambers.</p>
          <p>This events are not considered the cause of the volcanic eruption but a consequence of its activity. These are characterised by their closed range to the volcano. It is accepted that non-volcanic earthquakes are those with an epicenter further than 25km from it.</p>
        </div>
      </div>
    </div>
  </div>
...
<div class="dashboard-wrapper">
  ...
  <div class="form-column">
    ...
    <div id="status-message" class="alert alert-info" style="display: none; margin-top: 1rem;"></div>
  </div>
