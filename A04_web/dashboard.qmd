...
<div class="form-group">
  ...
  <input type="date" id="date_i" class="form-control">
  
  <label for="date_f">Fecha Final:</label>
  <input type="date" id="date_f" class="form-control">
  ...
  <input type="number" id="radius" class="form-control" min="0.1" step="0.1">
</div>

<button id="execute-btn" class="btn btn-primary">Actualizar Datos</button>
<div id="status-message" class="alert alert-info" style="display:none;"></div>

<script>
  // Limitar fechas al día de hoy
  const today = new Date().toISOString().split('T')[0];
  document.getElementById("date_i").setAttribute("max", today);
  document.getElementById("date_f").setAttribute("max", today);
</script>
