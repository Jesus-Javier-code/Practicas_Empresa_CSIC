...
<div class="context-box">
  ...
  <div class="media-grid">
    ...
    <div class="video-wrapper">
      <div class="video-container">
        <iframe src="https://www.youtube.com/embed/5Q6yjyP4k5E" allowfullscreen></iframe>
      </div>
    ...
    <div class="video-wrapper">
      <div class="video-container">
        <iframe src="https://www.youtube.com/embed/3uNy5T-tWJw" allowfullscreen></iframe>
      </div>
...
<script>
// Solo una definición de toggleInfo que funcione para todos los popups
function toggleInfo(id) {
    const popup = document.getElementById(id);
    const isVisible = popup.style.display === 'block';
