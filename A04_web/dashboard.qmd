...
<div class="context-box">
    <div class="context-title">Volcanic Fury Captured</div>
    <div class="context-text">
        The most intense moments of the eruption were documented by scientists, journalists, and local residents. 
        These videos showcase the raw power of the eruption and its evolving activity patterns.
    </div>
    ...
    <div class="media-grid">
        ...
        <div class="video-secondary">
            <div class="small-video">
                <div class="video-container">
                    <iframe src="https://www.youtube.com/embed/5Q6yjyP4k5E" frameborder="0" allowfullscreen></iframe>
                </div>
            ...
            <div class="small-video">
                <div class="video-container">
                    <iframe src="https://www.youtube.com/embed/3uNy5T-tWJw" frameborder="0" allowfullscreen></iframe>
                </div>
...
<div class="main-container">
  <!-- Hero Banner -->
  <div class="hero-banner">
    <div class="hero-title">Fumarolic Activity in El Teide</div>
    <div class="hero-subtitle">
...
<div class="context-box combined-analysis">
  ...
  <!-- Credits Footer -->
  <div class="credits-footer">
    <p><strong>Data sources:</strong> NASA LAADS DAAC • IGN Spain • INVOLCAN</p>
    <p>All content presented for educational and scientific research purposes</p>
  </div>
</div>
...
<div class="context-box">
    ...
    <div class="media-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
        ...
        <div class="video-wrapper">
            <div class="video-container">
                <iframe src="https://www.youtube.com/watch?v=6oXnAwbIQFI" frameborder="0" allowfullscreen></iframe>
            </div>
            <div class="video-caption">Aerial views of El Teide captured by dron</div>
        </div>

        <!-- Video 2 -->
        <div class="video-wrapper">
            <div class="video-container">
                <iframe src="https://www.youtube.com/watch?v=BD3C7mA2BAg" frameborder="0" allowfullscreen></iframe>
            </div>
        ...
        <div class="video-wrapper">
            <div class="video-container">
                <iframe src="https://www.youtube.com/watch?v=evq6QsfqAZQ" frameborder="0" allowfullscreen></iframe>
            </div>
        ...
        <div class="video-wrapper">
            <div class="video-container">
                <iframe src="https://www.youtube.com/watch?v=LT1Jd4RV8mg" frameborder="0" allowfullscreen></iframe>
            </div>
