...
.carousel-dots {
  ...
  gap: 12px;
  margin-top: 20px;
  flex-direction: row; /* Esto asegura disposición horizontal */
}
...
document.addEventListener('DOMContentLoaded', function() {
    const images = [
        ...
        {
            src: "https://dims.apnews.com/dims4/default/54085d9/2147483647/strip/true/crop/3000x2000+0+0/resize/599x399!/quality/90/?url=https%3A%2F%2Fstorage.googleapis.com%2Fafs-prod%2Fmedia%2F51c88d083ec149bd83d7899bf6e8d655%2F3000.jpeg",
    ...
    function updateCarousel(index) {
        // Actualiza imagen y créditos
        mainImage.style.opacity = 0;
       
        setTimeout(() => {
            mainImage.src = images[index].src;
            photoCredits.innerHTML = images[index].credit; // Actualiza el contenido HTML de los créditos
