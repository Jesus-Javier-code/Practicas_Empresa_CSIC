...
#| include: false
import subprocess
subprocess.run(["python", "../A01_source/B01_4_eq_processing/process_eq_data.py"], check=True)
```
...
```{python}
#| label: eq-map
#| fig-cap: "Mapa de Terremotos"
#| echo: false
from IPython.display import HTML

try:
    display(HTML(open("../A00_data/B_images/eq_map.html", "r").read()))
...
try:
    display(HTML(open("../A00_data/B_images/eq_table.html", "r").read()))
except Exception as e:
    print(f"Error mostrando la tabla: {e}")

```

```{python}
#| label: eq-hist
#| fig-cap: "Histograma del Índice de Trigger"
#| echo: false
from IPython.display import Image, display

try:
    display(Image("../A00_data/B_images/trigger_index_histogram.png"))
except Exception as e:
    print(f"Error mostrando el histograma: {e}")
```
